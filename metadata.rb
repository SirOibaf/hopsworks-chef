...
recipe  "hopsworks::default", "Installs HopsWorks war file, starts glassfish+application."
...
attribute "hopsworks/jwt/lifetime_ms",
          :description => "Default lifetime in ms for jwt expiration. (default 1.1.000)",
          :type => 'string'
