...
cookbook 'hops', github: "siroibaf/hops-hadoop-chef", branch: "LinuxContainerExecutor"
...
cookbook 'hopsmonitor', github: "siroibaf/hopsmonitor-chef", branch: "LinuxContainerExecutor"
